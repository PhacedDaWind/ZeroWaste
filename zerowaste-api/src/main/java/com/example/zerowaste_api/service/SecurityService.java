...
public class SecurityService {
    ...
    public SecurityService(UsersDAO usersDAO, PasswordEncoder passwordEncoder, EmailService emailService) {
    ...
    public void verify2faSetup(String username, String verificationCode, String newPassword) {
        ...
        if (user.getPasswordResetCode() == null || user.getTwoFactorExpiresAt().isBefore(LocalDateTime.now())) {
            throw new IllegalStateException("Verification code is invalid or has expired.");
        }
